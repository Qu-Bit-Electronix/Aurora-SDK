...
\begin{DoxyEnumerate}
\item Download, and run the \href{https://media-obsy-dev.fra1.digitaloceanspaces.com/installers/DaisyToolchain-1.0.0-win64.exe}{\texttt{ Daisy Toolchain for Windows installer}} from Qu-\/bit website.
...
\begin{DoxyEnumerate}
\item Download the \href{https://media-obsy-dev.fra1.digitaloceanspaces.com/installers/DaisyToolchain-macos-installer-x64-0.1.2.pkg}{\texttt{ Daisy Toolchain for Mac OS installer}} from the Qu-\/\+Bit website.
\item Unzip, and Double click, the {\ttfamily install.\+command} file contained within.
\end{DoxyEnumerate}

There are some additional helper scripts that require python, but this is optional.

Mac OS comes with python, but the latest version can be downloaded from \href{https://www.python.org/downloads/}{\texttt{ python.\+org}}, or using homebrew.

If during the steps below, you run into an error similar to the following\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{xcrun: error: invalid active developer path}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md5}{}\doxysubsection{Cloning the SDK}\label{index_autotoc_md5}
